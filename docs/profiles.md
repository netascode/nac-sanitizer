...
| `catalyst_center` | Catalyst Center (DNAC)   | (none - credentials masked by API) | usernames, hostnames, serial numbers, MAC addresses, location data, virtual network names, VLAN names, IP pool names, security group names, site names, physical addresses, domain names |
